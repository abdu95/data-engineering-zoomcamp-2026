...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers= 4) as executor:
        results = list(executor.map(upload_to_gcs, filter(None, file_paths)))

    print("All files processed and verified.", sum(1 for r in results if r))